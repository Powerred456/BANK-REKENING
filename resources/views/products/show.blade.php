...
@section('contents')
    ...
    <div class="row">
        <div class="col mb-3">
            <label class="form-label">kode_bank_rekening</label>
            <input type="text" name="kode_bank_rekening" class="form-control" placeholder="kode_bank_rekening" value="{{ $product->title }}" readonly>
        </div>
        <div class="col mb-3">
